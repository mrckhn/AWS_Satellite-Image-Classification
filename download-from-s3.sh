...
aws s3 cp s3://aws-satellite-lidar-tutorial/data/ ./data/ --recursive --no-sign-request --quiet

echo "===== Downloading pretrained model weights (617MB) ... ====="
aws s3 cp s3://aws-satellite-lidar-tutorial/models/ ./models/ --recursive --no-sign-request --quiet
